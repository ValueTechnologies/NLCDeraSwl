...
namespace NLCDeraSwl
{
    public partial class PasswordReset : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static void ForgotPassword(string userid, string emailAddress)
        {
            string NewPassword = "abc123";
            DBManagerPSICMisc dbMan = new DBManagerPSICMisc();

            Fn.Exec("UPDATE Login SET Password = '" + Encryptor.Encrypt(NewPassword) + "' where UserName = '" + emailAddress + "'");
