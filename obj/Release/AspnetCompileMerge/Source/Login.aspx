<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="NLCDeraSwl.Login" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <%--<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />--%>
    <title>NLC Dera Swl</title>
...
<body class="loginPage">
                    ...
                    <div class="navbar-inner">
                        <div class="container">
                            <table style="width: 100%;">
                                <tr>
                                    <td style="width: 10%;">
                                        <img src="Images/Logo.bmp" alt="Images/VR_Logo.png" style="height: 60px; margin-top: -1px; width: 70px;" />
                                    </td>
                                    <td style="text-align: left;">
                                        <a class="brand" href="#" style="text-align: left; font-family: 'Arial Rounded MT Bold'; font-weight: lighter; color: #25764C;">NLC DERA SWL <span class="slogan">(NLC)</span></a>
                                    </td>
                                    <td style="width: 28%;">
                                        <label></label>
                                    </td>
                ...
                <div class="form-row row-fluid">
                    <div class="span12">
                        <div class="row-fluid">
                            ...
                            <input class="span12" id="username" type="text" name="username" value="" placeholder="Username" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row row-fluid">
                    <div class="span12">
                        <div class="row-fluid">
                            ...
                            <input class="span12" id="password" type="password" name="password" value="" placeholder="Password" />
                        </div>
                    </div>
                </div>
                <div class="form-row row-fluid">
    ...
    <div style="height: 100%; width: 100%;">
        <img src="Images/Logo.bmp" style="position: absolute; margin-top: 3%; margin-left: 17%; z-index: -100; width: 67%; height: 93%; opacity: 0.069;">
    </div>
