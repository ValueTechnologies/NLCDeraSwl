<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="Designations.aspx.cs" Inherits="NLCDeraSwl.Designations" %>
                ...
                $.ajax({
                    ...
                    success: function (responseText) {
                        ...
                        $.each(jData, function (i, item) {
                            out = out + '<tr> <td> ' + item.srno + '</td> <td> ' + item.Designation + '</td> <td> ' + item.DesignationDetail + '</td>    <td tag="' + item.HMID + '"> ' + item.HigherManagment + '</td>     <td> <img src="Images/EditInfo.png" tag="' + item.DesignationID + '" class="EditInfo" style="width:20px; height : 20px;" /></td></tr>';
                        });
