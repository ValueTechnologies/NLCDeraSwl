<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="JournalVoucher.aspx.cs" Inherits="NLCDeraSwl.JournalVoucher" %>
                    ...
                    <form class="form-horizontal" action="#">
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                ...
                                <input type="text" class="span7" id="txtVoucherNo" disabled="disabled" />
                            </div>
                        </div>
