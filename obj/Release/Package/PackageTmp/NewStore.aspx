<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="NewStore.aspx.cs" Inherits="NLCDeraSwl.NewStore" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    &nbsp;
    <script type="text/javascript">
        $(document).ready(function () {
            $('.heading h3').html('Create New Store / Warehouse');
            ...
            $('#btnSave').bind('click', function () {
                ...
                if ($('#txtShopName').val().trim() == "") {
                    alert('Please Enter Store / Warehouse Name');
                    return;
                }
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    url: "NewStore.aspx/SaveShop",
                    data: "{ 'Name' : '" + $('#txtShopName').val().trim() + "', 'ShopDistID' : '" + $('#ddDistt').val() + "', 'TehsilId' : '" + $('#ddTeh').val() + "', 'ShopAbbv' : '" + $('#txtShopAbbv').val() + "', 'GPS' : '" + $('#txtGPS').val() + "', 'Address' : '" + $('#txtAddress').val() + "' }",
                    success: function (response) {
                        ...
                        $.ajax({
                            ...
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            url: "NewStore.aspx/SaveLevel",
                            data: "{ 'ID' : '" + jData[0].ID + "', 'Name' : '" + $('#txtShopName').val().trim() + "' }",
                            success: function (response) {
                                debugger;
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        try {
                            ...
                            $.each(jData, function (i, item) {
                                Out = Out + '<tr><td> ' + item.Srno + '</td><td style="text-align : left;"> ' + item.ShopName + ' </td><td  style="text-align : left;"> ' + item.DistrictName + ' </td><td  style="text-align : left;"> ' + item.TehsilName + ' </td><td  style="text-align : left;"> ' + item.ShopAddress + ' </td></tr>';
                            });
        ...
        $(document).ready(function () {
            ...
            function LoadTargetMap(obj) {
                ...
                var marker = new google.maps.Marker({
                    ...
                    map: map,
                    draggable: true,
                    icon: 'Images/gmap-markerRMIS.png'
                });
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="box">
                <div class="title">
                    <h4>
                        <span>Create New Store / Warehouse</span>
                    </h4>
                ...
                <div class="content" id="dvNewShop">
                    ...
                    <form class="form-horizontal" action="#">
                        <div class="form-row row-fluid">
                            <div class="span12">
                                <label class="form-label span3" style="margin-top: 9px;" for="normal">Store / Warehouse Name : </label>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                <label class="form-label span3" style="margin-top: 9px;" for="normal">Store / Warehouse Abbv : </label>
                                <input id="txtShopAbbv" type="text" class="span7" />
                            </div>
                        </div>

                        <div class="form-row row-fluid">
                            <div class="span12">
                                <label class="form-label span3" for="normal">Store In : </label>
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="box">
                <div class="title">
                    <h4>
                        <span>All Stores / Warehouse</span>
                    </h4>
