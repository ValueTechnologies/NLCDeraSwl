<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="CashVoucher.aspx.cs" Inherits="NLCDeraSwl.CashVoucher" %>
                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span6">
                                                ...
                                                <input class="span8" id="txtCPVVoucherNo" type="text" disabled="disabled" />
                                            </div>
                                            <div class="span6">
                                ...
                                <div class="form-row row-fluid">
                                    <div class="span12">
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span6">
                                                <label class="form-label span4" for="normal">Voucher No.</label>
                                                <input class="span8" id="txtCRVVoucherNo" type="text" disabled="disabled" />
                                            </div>
                                            <div class="span6">
                                                <label class="form-label span4" for="normal">Entry Date</label>
