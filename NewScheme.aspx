<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="NewScheme.aspx.cs" Inherits="NLCDeraSwl.NewScheme" %>
        ...
        $('body').on({
            click: function () {
                ...
                $.ajax({
                    ...
                    data: "{ 'schemeName' : '" + $('#txtSchemeName').val().trim() + "', 'districtID' : '" + $('#ddDistt').val() + "', 'TehsilID' : '" + $('#ddTeh').val() + "', 'startingDate' : '" + $('#txtStartingDate').val() + "'  , 'GPS' : '" + $('#txtGPS').val() + "' }",
        ...
        function LoadSchemes() {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.each(jData, function (i, item) {
                        Out = Out + '<tr><td> ' + item.Srno + '</td><td style="text-align : left;"> ' + item.Scheme + ' </td><td> ' + item.StartingDate + ' </td><td> ' + item.Tehsil + ' </td></tr>';
                    });
                ...
                <div class="content" id="dvNewScheme">
                    ...
                    <form class="form-horizontal" action="#">
                        <div class="form-row row-fluid">
                            <div class="span12">
                                <label class="form-label span3" style="margin-top: 9px;" for="normal">Scheme Name : </label>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                <label class="form-label span3" for="normal">Scheme In : </label>
                                <div class="span8" style="margin-left: 0px;">
                                    <table>
                                        <tr>
                                            <td>District</td>
                                            <td style="width: 250px;">
                                                <select id="ddDistt" class="vl frmCtrl" name="D1"></select>
                                            </td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                            <td>Tehsil</td>
                                            <td style="width: 250px;">
                                                <select id="ddTeh" class="vl frmCtrl">
                                                </select>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <table id="tbSchemes" class="responsive table table-striped table-bordered table-condensed">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 200px;">Starting Date
                                            </th>
                                            <th>Estate Tehsil
                                            </th>
                                        </tr>
