<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="BankVoucher.aspx.cs" Inherits="NLCDeraSwl.BankVoucher" %>
                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span6">
                                                ...
                                                <input class="span6" id="txtBPVVoucherNo" type="text" disabled="disabled" />
                                            </div>
                                            <div class="span6">
                                ...
                                <div class="form-row row-fluid">
                                    <div class="span12">
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span6">
                                                <label class="form-label span4" for="normal">Voucher No.</label>
                                                <input class="span6" id="txtBRVVoucherNo" type="text" disabled="disabled" />
                                            </div>
                                            <div class="span6">
                                                <label class="form-label span4" for="normal">Entry Date</label>
